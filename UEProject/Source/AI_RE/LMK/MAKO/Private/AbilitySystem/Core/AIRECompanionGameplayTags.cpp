...
namespace AIRECompanionGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(AbilityCombatAutonomousEvade, "Ability.Companion.Combat.Evade.Autonomous", "Companion autonomous collision-safe evade ability.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(EventAttackTrace, "Event.Companion.Attack.Trace", "Root tag for companion basic attack trace window events.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(EventAttackTraceBegin, "Event.Companion.Attack.Trace.Begin", "Opens and samples the active basic attack trace window.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(EventAttackTraceSample, "Event.Companion.Attack.Trace.Sample", "Samples the active basic attack trace window.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(EventAttackTraceEnd, "Event.Companion.Attack.Trace.End", "Samples and closes the active basic attack trace window.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(EventCombatSkillTrace, "Event.Companion.CombatSkill.Trace", "Root tag for companion combat skill trace window events.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(EventCombatSkillTraceBegin, "Event.Companion.CombatSkill.Trace.Begin", "Opens and samples the active combat skill trace window.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(EventCombatSkillTraceSample, "Event.Companion.CombatSkill.Trace.Sample", "Samples the active combat skill trace window.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(EventCombatSkillTraceEnd, "Event.Companion.CombatSkill.Trace.End", "Samples and closes the active combat skill trace window.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(EventAutonomousEvadeRequest, "Event.Companion.Evade.Autonomous.Request", "Requests an autonomous evade from the enemy attack in the gameplay event payload.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(CooldownAutonomousEvade, "Cooldown.Companion.Evade.Autonomous", "Companion autonomous evade cooldown is active.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(DataAutonomousEvadeStaminaCost, "Data.Companion.Evade.Autonomous.StaminaCost", "Negative stamina delta supplied by a successful autonomous evade.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(DataAutonomousEvadeCooldownDuration, "Data.Companion.Evade.Autonomous.CooldownDuration", "Duration supplied to the autonomous evade cooldown Gameplay Effect.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(DataAutonomousEvadeRegenBlockDuration, "Data.Companion.Evade.Autonomous.RegenBlockDuration", "Duration before stamina regeneration resumes after an autonomous evade.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(DataAutonomousEvadeInvulnerabilityDuration, "Data.Companion.Evade.Autonomous.InvulnerabilityDuration", "Duration supplied to the autonomous evade invulnerability Gameplay Effect.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(DataStaminaRegenPerTick, "Data.Companion.Stamina.RegenPerTick", "Positive stamina delta supplied to each periodic regeneration execution.");
